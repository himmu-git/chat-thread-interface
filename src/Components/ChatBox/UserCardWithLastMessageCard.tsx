...
const UserCardWithLastMessageCard = (props: Props) => {
  return (
    <div className="userCardWithLastMessage">
      <img className="profileImageInUserCard" src={userImageFallback} alt="" />
      <div>
        <div className="userNameInCard">Himanshu</div>
        <div className="userMsgInUserCard">This is Last message.</div>
      </div>
      <div>14/08</div>
    </div>
  );
